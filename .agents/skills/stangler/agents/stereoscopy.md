...
The drafted ADR must reside under `docs/adr/ADR-NNN-short-title.md` and present:

1. **Problem Context**: Identify business requirements, technical constraints, team capabilities, and time pressure. Reference the Bounded Context and glossary terms in `docs/GLOSSARY.md`.
