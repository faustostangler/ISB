...
4. **Anti-Corruption Integration**: Any structural change affecting bounded context boundaries must pass through the Anti-Corruption Layer (ACL) defined in [Legacy Strangling Patterns](file:///mnt/gamer_d/Fausto%20Stangler/Documentos/Python/ISB/.agents/skills/stangler/references/legacy_strangling_patterns.md).
