...
### References
- Refer to the shared [legacy_strangling_patterns.md](../stangler/references/legacy_strangling_patterns.md) for detailed ACL construction directives, mappers, and adapters.
